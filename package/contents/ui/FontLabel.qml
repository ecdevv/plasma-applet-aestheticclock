...
Item {
    ...
    Text {
        id: label
        font.family: root.fontFamily || "Sans Serif"
    ...
    Text {
        ...
        height: labelWrapper.fill ? (currentVal > 0 ? ((metrics.ascent-metrics.descent + (font.pixelSize*0.1))/(((to-from)+1)/currentVal))+metrics.descent : 0) : 0
